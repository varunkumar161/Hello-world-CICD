package org.reddy.webapp.controllers;
...
import org.reddy.webapp.models.Greeting;
...
public class HelloWorldController {
    ...
    public ResponseEntity<Greeting> getGreeting(
        @ApiParam(name = "email", value = "email address greeting will be sent to, e.g. 'reddy@xyz.com'", required = false) @RequestParam(name = "email", required = false) String email
        ) {
